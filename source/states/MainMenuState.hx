...
class MainMenuState extends MusicBeatState
{
	...
	public static var recodeVersion:String = '0.1';
	...
	override function create()
	{
		...
		var fnfVer:FlxText = new FlxText(0, FlxG.height - 18, FlxG.width, 'v${funkinVersion} (P-Slice ${pSliceVersion}, Recode ${recodeVersion})', 12);
